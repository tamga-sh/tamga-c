...
static void modexp_is(const char *modulus_hex, const char *base_hex,
                      const char *exponent_hex, const char *expected_hex)
{
...
{
    modexp_is(
        "c40abd638f81efe20109a3490ade118a700f3a6bb11f16cdb8e560169434acaa"
...
TT_TEST(modexp_rejects_inputs_that_break_its_preconditions)
{
    ...
    /* even modulus */
    modulus[255] = 0xfeu;
    TT_ASSERT_FALSE(tamga_bn_modexp(base, modulus, sizeof(modulus), exponent,
                                    sizeof(exponent), out));

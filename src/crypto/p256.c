...
static void p256_mod_add(const P256Mod *ctx, uint32_t r[P256_LIMBS],
                         const uint32_t a[P256_LIMBS], const uint32_t b[P256_LIMBS])
{
...
static void p256_mod_sub(const P256Mod *ctx, uint32_t r[P256_LIMBS],
                         const uint32_t a[P256_LIMBS], const uint32_t b[P256_LIMBS])
{
...
static void p256_mont_mul(const P256Mod *ctx, uint32_t r[P256_LIMBS],
                          const uint32_t a[P256_LIMBS], const uint32_t b[P256_LIMBS])
{
...
static void p256_to_mont(const P256Mod *ctx, uint32_t r[P256_LIMBS],
...
static void p256_double_scalar_mul(const P256Mod *fp, P256Point *out,
                                   const uint32_t k1[P256_LIMBS], const P256Point *p1,
                                   const uint32_t k2[P256_LIMBS], const P256Point *p2)
{
